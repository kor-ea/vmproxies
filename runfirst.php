...
$alive_count = count($memcache->get('all'));
$us_count = count($memcache->get('us'));
echo "running ".$alive_count." proxies, ".$us_count." of them from US".PHP_EOL;
if($alive_count < 50 ){
...
echo 'checking '.$running_count.PHP_EOL;
